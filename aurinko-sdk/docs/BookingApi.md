...
|------------- | ------------- | -------------|
| [**bookingAccountCreateMeeting**](BookingApi.md#bookingAccountCreateMeeting) | **POST** /v1/book/account/profiles/{id}/meeting | Create a meeting |
| [**bookingAccountCreateMeetingWithHttpInfo**](BookingApi.md#bookingAccountCreateMeetingWithHttpInfo) | **POST** /v1/book/account/profiles/{id}/meeting | Create a meeting |
| [**bookingAccountMeetingTimes**](BookingApi.md#bookingAccountMeetingTimes) | **GET** /v1/book/account/profiles/{id}/meeting | Get available meeting times |
| [**bookingAccountMeetingTimesWithHttpInfo**](BookingApi.md#bookingAccountMeetingTimesWithHttpInfo) | **GET** /v1/book/account/profiles/{id}/meeting | Get available meeting times |
| [**bookingAccountReservationConfirm**](BookingApi.md#bookingAccountReservationConfirm) | **POST** /v1/book/account/reservations/{id}/confirm | Convert an unconfirmed booking reservation to a calendar event |
| [**bookingAccountReservationConfirmWithHttpInfo**](BookingApi.md#bookingAccountReservationConfirmWithHttpInfo) | **POST** /v1/book/account/reservations/{id}/confirm | Convert an unconfirmed booking reservation to a calendar event |
| [**bookingAccountReservationDelete**](BookingApi.md#bookingAccountReservationDelete) | **DELETE** /v1/book/account/reservations/{id} | Cancel an unconfirmed booking reservation |
| [**bookingAccountReservationDeleteWithHttpInfo**](BookingApi.md#bookingAccountReservationDeleteWithHttpInfo) | **DELETE** /v1/book/account/reservations/{id} | Cancel an unconfirmed booking reservation |
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling BookingApi#bookingAccountCreateMeeting");
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling BookingApi#bookingAccountMeetingTimes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ConfirmReservationOutDto> bookingAccountReservationConfirm(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ConfirmReservationOutDto> result = apiInstance.bookingAccountReservationConfirm(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling BookingApi#bookingAccountReservationConfirm");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<ConfirmReservationOutDto>> bookingAccountReservationConfirm bookingAccountReservationConfirmWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | An unconfirmed reservation id
        try {
            CompletableFuture<ApiResponse<ConfirmReservationOutDto>> response = apiInstance.bookingAccountReservationConfirmWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<ConfirmSlotDeleteOutDto> bookingAccountReservationDelete(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | An unconfirmed reservation id
        try {
            CompletableFuture<ConfirmSlotDeleteOutDto> result = apiInstance.bookingAccountReservationDelete(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling BookingApi#bookingAccountReservationDelete");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<ConfirmSlotDeleteOutDto>> bookingAccountReservationDelete bookingAccountReservationDeleteWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | An unconfirmed reservation id
        try {
            CompletableFuture<ApiResponse<ConfirmSlotDeleteOutDto>> response = apiInstance.bookingAccountReservationDeleteWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
