...
|------------- | ------------- | -------------|
| [**createDraft**](DraftsApi.md#createDraft) | **POST** /v1/email/drafts | Create a new draft message |
| [**createDraftWithHttpInfo**](DraftsApi.md#createDraftWithHttpInfo) | **POST** /v1/email/drafts | Create a new draft message |
| [**deleteDraft**](DraftsApi.md#deleteDraft) | **DELETE** /v1/email/drafts/{draftId} | Delete a draft message |
| [**deleteDraftWithHttpInfo**](DraftsApi.md#deleteDraftWithHttpInfo) | **DELETE** /v1/email/drafts/{draftId} | Delete a draft message |
| [**getDraft**](DraftsApi.md#getDraft) | **GET** /v1/email/drafts/{draftId} | Get a draft message |
| [**getDraftWithHttpInfo**](DraftsApi.md#getDraftWithHttpInfo) | **GET** /v1/email/drafts/{draftId} | Get a draft message |
| [**sendDraft**](DraftsApi.md#sendDraft) | **POST** /v1/email/drafts/{draftId}/send | Send a draft message |
| [**sendDraftWithHttpInfo**](DraftsApi.md#sendDraftWithHttpInfo) | **POST** /v1/email/drafts/{draftId}/send | Send a draft message |
| [**updateDraft**](DraftsApi.md#updateDraft) | **PUT** /v1/email/drafts/{draftId} | Update a draft message |
| [**updateDraftWithHttpInfo**](DraftsApi.md#updateDraftWithHttpInfo) | **PUT** /v1/email/drafts/{draftId} | Update a draft message |



## createDraft

> CompletableFuture<EmailDraftResponse> createDraft(bodyType, outgoingEmail)
...
import io.aurinko.api.DraftsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<EmailDraftResponse> result = apiInstance.createDraft(bodyType, outgoingEmail);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling DraftsApi#createDraft");
...
CompletableFuture<[**EmailDraftResponse**](EmailDraftResponse.md)>
...
> CompletableFuture<ApiResponse<EmailDraftResponse>> createDraft createDraftWithHttpInfo(bodyType, outgoingEmail)
...
public class Example {
    public static void main(String[] args) {
        ...
        OutgoingEmail outgoingEmail = new OutgoingEmail(); // OutgoingEmail | 
        try {
            CompletableFuture<ApiResponse<EmailDraftResponse>> response = apiInstance.createDraftWithHttpInfo(bodyType, outgoingEmail);
...
CompletableFuture<ApiResponse<[**EmailDraftResponse**](EmailDraftResponse.md)>>
...
> CompletableFuture<OkResponse> deleteDraft(draftId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<OkResponse> result = apiInstance.deleteDraft(draftId);
            System.out.println(result.get());
        } catch (ApiException e) {
...
## deleteDraftWithHttpInfo

> CompletableFuture<ApiResponse<OkResponse>> deleteDraft deleteDraftWithHttpInfo(draftId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String draftId = "draftId_example"; // String | an identifier of a draft message
        try {
            CompletableFuture<ApiResponse<OkResponse>> response = apiInstance.deleteDraftWithHttpInfo(draftId);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
> CompletableFuture<EmailDraft> getDraft(draftId, bodyType, nativeProperties, loadInlines)
...
public class Example {
    public static void main(String[] args) {
        ...
        DraftsApi apiInstance = new DraftsApi(defaultClient);
        String draftId = "draftId_example"; // String | draft message identifier
        BodyType bodyType = BodyType.fromValue("html"); // BodyType | 
        ...
        try {
            CompletableFuture<EmailDraft> result = apiInstance.getDraft(draftId, bodyType, nativeProperties, loadInlines);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling DraftsApi#getDraft");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **draftId** | **String**| draft message identifier | |
| **bodyType** | [**BodyType**](.md)|  | [optional] [enum: html, text] |
...
CompletableFuture<[**EmailDraft**](EmailDraft.md)>
...
> CompletableFuture<ApiResponse<EmailDraft>> getDraft getDraftWithHttpInfo(draftId, bodyType, nativeProperties, loadInlines)
...
public class Example {
    public static void main(String[] args) {
        ...
        Boolean loadInlines = false; // Boolean | automatically pre-load relevant inline attachments
        try {
            CompletableFuture<ApiResponse<EmailDraft>> response = apiInstance.getDraftWithHttpInfo(draftId, bodyType, nativeProperties, loadInlines);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**EmailDraft**](EmailDraft.md)>>
...
|------------- | ------------- | ------------- | -------------|
| **draftId** | **String**| an identifier of a draft message | |
| **sendTime** | **OffsetDateTime**|  | [optional] |
| **draftSendDetails** | [**DraftSendDetails**](DraftSendDetails.md)|  | [optional] |
...
> CompletableFuture<EmailDraftResponse> updateDraft(draftId, bodyType, outgoingEmail)
...
public class Example {
    public static void main(String[] args) {
        ...
        OutgoingEmail outgoingEmail = new OutgoingEmail(); // OutgoingEmail | 
        try {
            CompletableFuture<EmailDraftResponse> result = apiInstance.updateDraft(draftId, bodyType, outgoingEmail);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling DraftsApi#updateDraft");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<EmailDraftResponse>> updateDraft updateDraftWithHttpInfo(draftId, bodyType, outgoingEmail)
...
public class Example {
    public static void main(String[] args) {
        ...
        OutgoingEmail outgoingEmail = new OutgoingEmail(); // OutgoingEmail | 
        try {
            CompletableFuture<ApiResponse<EmailDraftResponse>> response = apiInstance.updateDraftWithHttpInfo(draftId, bodyType, outgoingEmail);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
