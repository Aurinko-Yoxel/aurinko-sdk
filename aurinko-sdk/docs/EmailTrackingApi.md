...
| [**trackingById**](EmailTrackingApi.md#trackingById) | **GET** /v1/email/tracking/{id} | Get tracking data by Id |
| [**trackingByIdWithHttpInfo**](EmailTrackingApi.md#trackingByIdWithHttpInfo) | **GET** /v1/email/tracking/{id} | Get tracking data by Id |
| [**trackingEventById**](EmailTrackingApi.md#trackingEventById) | **GET** /v1/email/tracking/{trackingId}/events/{id} | Get tracking event by Id |
| [**trackingEventByIdWithHttpInfo**](EmailTrackingApi.md#trackingEventByIdWithHttpInfo) | **GET** /v1/email/tracking/{trackingId}/events/{id} | Get tracking event by Id |
| [**trackingEvents**](EmailTrackingApi.md#trackingEvents) | **GET** /v1/email/tracking/{id}/events | List tracking events |
| [**trackingEventsWithHttpInfo**](EmailTrackingApi.md#trackingEventsWithHttpInfo) | **GET** /v1/email/tracking/{id}/events | List tracking events |
...
> CompletableFuture<TrackingData> trackingById(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        EmailTrackingApi apiInstance = new EmailTrackingApi(defaultClient);
        Long id = 56L; // Long | Tracking data id
        try {
            CompletableFuture<TrackingData> result = apiInstance.trackingById(id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling EmailTrackingApi#trackingById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **id** | **Long**| Tracking data id | |

### Return type

CompletableFuture<[**TrackingData**](TrackingData.md)>
...
> CompletableFuture<ApiResponse<TrackingData>> trackingById trackingByIdWithHttpInfo(id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | Tracking data id
        try {
            CompletableFuture<ApiResponse<TrackingData>> response = apiInstance.trackingByIdWithHttpInfo(id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**TrackingData**](TrackingData.md)>>
...
> CompletableFuture<EmailTrackingEvent> trackingEventById(trackingId, id)
...
public class Example {
    public static void main(String[] args) {
        ...
        EmailTrackingApi apiInstance = new EmailTrackingApi(defaultClient);
        Long trackingId = 56L; // Long | Tracking data id
        Long id = 56L; // Long | Tracking event id
        try {
            CompletableFuture<EmailTrackingEvent> result = apiInstance.trackingEventById(trackingId, id);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling EmailTrackingApi#trackingEventById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **trackingId** | **Long**| Tracking data id | |
| **id** | **Long**| Tracking event id | |

### Return type

CompletableFuture<[**EmailTrackingEvent**](EmailTrackingEvent.md)>
...
> CompletableFuture<ApiResponse<EmailTrackingEvent>> trackingEventById trackingEventByIdWithHttpInfo(trackingId, id)
...
public class Example {
    public static void main(String[] args) {
        ...
        Long id = 56L; // Long | Tracking event id
        try {
            CompletableFuture<ApiResponse<EmailTrackingEvent>> response = apiInstance.trackingEventByIdWithHttpInfo(trackingId, id);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**EmailTrackingEvent**](EmailTrackingEvent.md)>>
...
> CompletableFuture<EmailTrackingEventPageNext> trackingEvents(id, limit, offset)
...
public class Example {
    public static void main(String[] args) {
        ...
        EmailTrackingApi apiInstance = new EmailTrackingApi(defaultClient);
        Long id = 56L; // Long | Tracking id
        Integer limit = 50; // Integer | page size
        Integer offset = 0; // Integer | return records offset by the given number
        try {
            CompletableFuture<EmailTrackingEventPageNext> result = apiInstance.trackingEvents(id, limit, offset);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling EmailTrackingApi#trackingEvents");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<EmailTrackingEventPageNext>> trackingEvents trackingEventsWithHttpInfo(id, limit, offset)
...
public class Example {
    public static void main(String[] args) {
        ...
        Integer offset = 0; // Integer | return records offset by the given number
        try {
            CompletableFuture<ApiResponse<EmailTrackingEventPageNext>> response = apiInstance.trackingEventsWithHttpInfo(id, limit, offset);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
