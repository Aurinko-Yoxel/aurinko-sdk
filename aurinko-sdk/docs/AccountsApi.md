...
| [**checkConnection**](AccountsApi.md#checkConnection) | **POST** /v1/am/accounts/connect | Check a connection, supported Office365, Google, IMAP |
| [**checkConnectionWithHttpInfo**](AccountsApi.md#checkConnectionWithHttpInfo) | **POST** /v1/am/accounts/connect | Check a connection, supported Office365, Google, IMAP |
...
> CompletableFuture<OkResponse> checkConnection(apiAccountInDto)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<OkResponse> result = apiInstance.checkConnection(apiAccountInDto);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling AccountsApi#checkConnection");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CompletableFuture<ApiResponse<OkResponse>> checkConnection checkConnectionWithHttpInfo(apiAccountInDto)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApiAccountInDto apiAccountInDto = new ApiAccountInDto(); // ApiAccountInDto | 
        try {
            CompletableFuture<ApiResponse<OkResponse>> response = apiInstance.checkConnectionWithHttpInfo(apiAccountInDto);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
...
| **serviceType** | [**ServiceTypeNonDaemon**](.md)|  | [optional] [enum: Google, Office365, EWS, IMAP, Salesforce, Salesflare, Repfabric, Slack, SugarCRM, HighLevel, Hubspot, Zoom, Webex, WebexBot, Pipedrive, EclipseERP, AutoQuotes, NetSuite, SpecPath, Zoho, Clientify, QuickBooks, ActiveCampaign, Creatio, ConstantContact, Fishbowl, iCloud] |
