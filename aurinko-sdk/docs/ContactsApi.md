...
|------------- | ------------- | -------------|
| [**contact**](ContactsApi.md#contact) | **GET** /v1/contacts/{contId} | Get a contact |
| [**contactWithHttpInfo**](ContactsApi.md#contactWithHttpInfo) | **GET** /v1/contacts/{contId} | Get a contact |
| [**createContact**](ContactsApi.md#createContact) | **POST** /v1/contacts | Create a new contact |
| [**createContactWithHttpInfo**](ContactsApi.md#createContactWithHttpInfo) | **POST** /v1/contacts | Create a new contact |
| [**deleteContact**](ContactsApi.md#deleteContact) | **DELETE** /v1/contacts/{contId} | Delete a contact |
| [**deleteContactWithHttpInfo**](ContactsApi.md#deleteContactWithHttpInfo) | **DELETE** /v1/contacts/{contId} | Delete a contact |
| [**updateContact**](ContactsApi.md#updateContact) | **PATCH** /v1/contacts/{contId} | Update a contact |
| [**updateContactWithHttpInfo**](ContactsApi.md#updateContactWithHttpInfo) | **PATCH** /v1/contacts/{contId} | Update a contact |
...
import io.aurinko.api.ContactsApi;
...
CompletableFuture<[**Contact**](Contact.md)>
...
CompletableFuture<ApiResponse<[**Contact**](Contact.md)>>
...
> CompletableFuture<ContactOrId> createContact(contact)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<ContactOrId> result = apiInstance.createContact(contact);
            System.out.println(result.get());
        } catch (ApiException e) {
...
CompletableFuture<[**ContactOrId**](ContactOrId.md)>
...
> CompletableFuture<ApiResponse<ContactOrId>> createContact createContactWithHttpInfo(contact)
...
public class Example {
    public static void main(String[] args) {
        ...
        Contact contact = new Contact(); // Contact | 
        try {
            CompletableFuture<ApiResponse<ContactOrId>> response = apiInstance.createContactWithHttpInfo(contact);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**ContactOrId**](ContactOrId.md)>>
...
> CompletableFuture<Void> deleteContact(contId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contId = "contId_example"; // String | Contact id
        try {
            CompletableFuture<Void> result = apiInstance.deleteContact(contId);
        } catch (ApiException e) {
...
> CompletableFuture<ApiResponse<Void>> deleteContact deleteContactWithHttpInfo(contId)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contId = "contId_example"; // String | Contact id
        try {
            CompletableFuture<ApiResponse<Void>> response = apiInstance.deleteContactWithHttpInfo(contId);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
        } catch (InterruptedException | ExecutionException e) {
            ApiException apiException = (ApiException)e.getCause();
...
> CompletableFuture<ContactOrId> updateContact(contId, ifMatch, contact)
...
public class Example {
    public static void main(String[] args) {
        ...
        Contact contact = new Contact(); // Contact | 
        try {
            CompletableFuture<ContactOrId> result = apiInstance.updateContact(contId, ifMatch, contact);
            System.out.println(result.get());
        } catch (ApiException e) {
...
> CompletableFuture<ApiResponse<ContactOrId>> updateContact updateContactWithHttpInfo(contId, ifMatch, contact)
...
public class Example {
    public static void main(String[] args) {
        ...
        Contact contact = new Contact(); // Contact | 
        try {
            CompletableFuture<ApiResponse<ContactOrId>> response = apiInstance.updateContactWithHttpInfo(contId, ifMatch, contact);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
