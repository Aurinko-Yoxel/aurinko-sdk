...
/**
 * API tests for FollowUpRobotApi
 */
@Ignore
public class FollowUpRobotApiTest {

    private final FollowUpRobotApi api = new FollowUpRobotApi();
    ...
    public void createRuleTest() throws ApiException {
        FollowupRuleAggregateIn followupRuleAggregateIn = null;
        CompletableFuture<FollowupRuleAggregateOut> response = 
        api.createRule(followupRuleAggregateIn);
    ...
    public void getConfigTest() throws ApiException {
        CompletableFuture<FollowupConfig> response = 
        api.getConfig();
     ...
     */
    @Test
    public void getConversationDripStatusTest() throws ApiException {
        String convoId = null;
        CompletableFuture<ConversationDripStatus> response = 
        api.getConversationDripStatus(convoId);
     ...
     */
    @Test
    public void getConversationsDripStatusTest() throws ApiException {
        Boolean active = null;
        Integer limit = null;
        Integer offset = null;
        CompletableFuture<ConversationDripStatus> response = 
    ...
    public void updateConfigTest() throws ApiException {
        ...
        CompletableFuture<FollowupConfig> response = 
        api.updateConfig(followupConfig);
     ...
     */
    @Test
    public void updateConversationDripStatusTest() throws ApiException {
        String convoId = null;
        DripRequestDTO dripRequestDTO = null;
        CompletableFuture<ConversationDripStatus> response = 
        api.updateConversationDripStatus(convoId, dripRequestDTO);
    ...
    public void updateRuleTest() throws ApiException {
        ...
        FollowupRuleAggregateIn followupRuleAggregateIn = null;
        CompletableFuture<FollowupRuleAggregateOut> response = 
        api.updateRule(id, followupRuleAggregateIn);
