...
public class FreeBusyScheduleApiTest {
     ...
     */
    @Test
    public void freeBusyTest() throws ApiException {
        FreeBusyRequest freeBusyRequest = null;
        CompletableFuture<FreeBusySchedulePage> response = 
        api.freeBusy(freeBusyRequest);
     ...
     */
    @Test
    public void suggestMeetingTimesTest() throws ApiException {
        SuggestMeetingTimesRequest suggestMeetingTimesRequest = null;
        CompletableFuture<SuggestMeetingTimesResponse> response = 
        api.suggestMeetingTimes(suggestMeetingTimesRequest);
