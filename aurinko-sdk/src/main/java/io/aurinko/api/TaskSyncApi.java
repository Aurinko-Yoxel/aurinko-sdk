...
public class TaskSyncApi {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("taskSyncDeleted", localVarResponse));
            }
            try {
  ...
  private HttpRequest.Builder taskSyncDeletedRequestBuilder(String taskListId, String deltaToken, String pageToken) throws ApiException {
    ...
    String localVarPath = "/v1/tasklists/{taskListId}/sync/deleted"
   ...
   * 
   * @param taskListId Task list id (required)
   * @param skipCompletedBeforeDate Skip completed tasks before date.  (optional)
  ...
  public CompletableFuture<SyncStatus> taskSyncStart(String taskListId, OffsetDateTime skipCompletedBeforeDate) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("taskSyncStart", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder taskSyncStartRequestBuilder(String taskListId, OffsetDateTime skipCompletedBeforeDate) throws ApiException {
    ...
    String localVarPath = "/v1/tasklists/{taskListId}/sync"
        .replace("{taskListId}", ApiClient.urlEncode(taskListId.toString()));

    List<Pair> localVarQueryParams = new ArrayList<>();
    StringJoiner localVarQueryStringJoiner = new StringJoiner("&");
    String localVarQueryParameterBaseName;
    localVarQueryParameterBaseName = "skipCompletedBeforeDate";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("skipCompletedBeforeDate", skipCompletedBeforeDate));
  ...
  public CompletableFuture<SyncTasksPage> taskSyncUpdated(String taskListId, String deltaToken, String pageToken) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("taskSyncUpdated", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<SyncTasksPage>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
  ...
  private HttpRequest.Builder taskSyncUpdatedRequestBuilder(String taskListId, String deltaToken, String pageToken) throws ApiException {
    ...
    String localVarPath = "/v1/tasklists/{taskListId}/sync/updated"
        .replace("{taskListId}", ApiClient.urlEncode(taskListId.toString()));
