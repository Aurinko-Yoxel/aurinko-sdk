...
public class FollowUpRobotApi {
   ...
   * 
   * @param followupRuleAggregateIn  (optional)
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("createRule", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<FollowupRuleAggregateOut>() {})
              );
            } catch (IOException e) {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<FollowupRuleAggregateOut>(
  ...
  private HttpRequest.Builder createRuleRequestBuilder(FollowupRuleAggregateIn followupRuleAggregateIn) throws ApiException {
    ...
    String localVarPath = "/v1/followup/rules";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(followupRuleAggregateIn);
  ...
  public CompletableFuture<OkResponse> deleteRule(Long id) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteRule", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder deleteRuleRequestBuilder(Long id) throws ApiException {
    ...
    String localVarPath = "/v1/followup/rules/{id}"
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<FollowupConfig> getConfig() throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getConfig", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<FollowupConfig>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<FollowupConfig>> getConfigWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getConfigRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<FollowupConfig>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<FollowupConfig>() {}))
              );
  ...
  private HttpRequest.Builder getConfigRequestBuilder() throws ApiException {
    ...
    String localVarPath = "/v1/followup/config";
   ...
   * 
   * @param convoId thread identifier (required)
  ...
  public CompletableFuture<ConversationDripStatus> getConversationDripStatus(String convoId) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getConversationDripStatus", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder getConversationDripStatusRequestBuilder(String convoId) throws ApiException {
    ...
    String localVarPath = "/v1/followup/conversations/{convoId}"
        .replace("{convoId}", ApiClient.urlEncode(convoId.toString()));
  ...
  public CompletableFuture<ConversationDripStatus> getConversationsDripStatus(Boolean active, Integer limit, Integer offset) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getConversationsDripStatus", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder getConversationsDripStatusRequestBuilder(Boolean active, Integer limit, Integer offset) throws ApiException {
    ...
    String localVarPath = "/v1/followup/conversations";
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<FollowupRuleAggregateOut> getRules() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getRulesRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<FollowupRuleAggregateOut>> getRulesWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = getRulesRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder getRulesRequestBuilder() throws ApiException {
  ...
  public CompletableFuture<FollowupConfig> updateConfig(FollowupConfig followupConfig) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("updateConfig", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder updateConfigRequestBuilder(FollowupConfig followupConfig) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(followupConfig);
  ...
  public CompletableFuture<ConversationDripStatus> updateConversationDripStatus(String convoId, DripRequestDTO dripRequestDTO) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("updateConversationDripStatus", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
  ...
  private HttpRequest.Builder updateConversationDripStatusRequestBuilder(String convoId, DripRequestDTO dripRequestDTO) throws ApiException {
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(dripRequestDTO);
      localVarRequestBuilder.method("PUT", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
  ...
  public CompletableFuture<FollowupRuleAggregateOut> updateRule(Long id, FollowupRuleAggregateIn followupRuleAggregateIn) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("updateRule", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
