...
public class FreeBusyScheduleApi {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("freeBusy", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<FreeBusySchedulePage>() {})
              );
            } catch (IOException e) {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<FreeBusySchedulePage>(
  ...
  private HttpRequest.Builder freeBusyRequestBuilder(FreeBusyRequest freeBusyRequest) throws ApiException {
    ...
    String localVarPath = "/v1/calendars/freeBusy";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(freeBusyRequest);
   ...
   * 
   * @param suggestMeetingTimesRequest  (optional)
  ...
  public CompletableFuture<SuggestMeetingTimesResponse> suggestMeetingTimes(SuggestMeetingTimesRequest suggestMeetingTimesRequest) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("suggestMeetingTimes", localVarResponse));
            }
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<SuggestMeetingTimesResponse>() {})
              );
            } catch (IOException e) {
              return CompletableFuture.failedFuture(new ApiException(e));
            }
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            ...
            try {
              String responseBody = localVarResponse.body();
              return CompletableFuture.completedFuture(
                  new ApiResponse<SuggestMeetingTimesResponse>(
                      localVarResponse.statusCode(),
                      localVarResponse.headers().map(),
                      responseBody == null || responseBody.isBlank() ? null : memberVarObjectMapper.readValue(responseBody, new TypeReference<SuggestMeetingTimesResponse>() {}))
              );
  ...
  private HttpRequest.Builder suggestMeetingTimesRequestBuilder(SuggestMeetingTimesRequest suggestMeetingTimesRequest) throws ApiException {
    ...
    String localVarPath = "/v1/calendars/suggestMeetingTimes";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(suggestMeetingTimesRequest);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
