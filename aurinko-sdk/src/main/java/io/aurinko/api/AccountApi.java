...
public class AccountApi {
   ...
   */
  public CompletableFuture<Void> deleteAccount() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteAccountRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteAccount", localVarResponse));
            }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Void>> deleteAccountWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteAccountRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder deleteAccountRequestBuilder() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<Void> deleteToken() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteTokenRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("deleteToken", localVarResponse));
            }
            return CompletableFuture.completedFuture(null);
      });
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public CompletableFuture<ApiResponse<Void>> deleteTokenWithHttpInfo() throws ApiException {
    try {
      HttpRequest.Builder localVarRequestBuilder = deleteTokenRequestBuilder();
      return memberVarHttpClient.sendAsync(
          localVarRequestBuilder.build(),
  ...
  private HttpRequest.Builder deleteTokenRequestBuilder() throws ApiException {
  ...
  public CompletableFuture<ApiAccountOutDto> getMyAccount(Boolean pingProvider) throws ApiException {
    try {
      ...
      return memberVarHttpClient.sendAsync(
          ...
          HttpResponse.BodyHandlers.ofString()).thenComposeAsync(localVarResponse -> {
            if (localVarResponse.statusCode()/ 100 != 2) {
              return CompletableFuture.failedFuture(getApiException("getMyAccount", localVarResponse));
            }
            try {
