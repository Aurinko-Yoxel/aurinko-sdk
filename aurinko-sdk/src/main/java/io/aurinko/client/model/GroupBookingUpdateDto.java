 ...
 */
@JsonPropertyOrder({
  GroupBookingUpdateDto.JSON_PROPERTY_NAME,
  GroupBookingUpdateDto.JSON_PROPERTY_DURATION_MINUTES,
  GroupBookingUpdateDto.JSON_PROPERTY_BUFFER_BETWEEN_MINUTES,
  GroupBookingUpdateDto.JSON_PROPERTY_AVAILABILITY_STEP,
  GroupBookingUpdateDto.JSON_PROPERTY_START_AFTER_MINUTES,
  GroupBookingUpdateDto.JSON_PROPERTY_START_TIME,
  GroupBookingUpdateDto.JSON_PROPERTY_END_TIME,
  GroupBookingUpdateDto.JSON_PROPERTY_TIME_AVAILABLE_FOR,
  GroupBookingUpdateDto.JSON_PROPERTY_SUBJECT,
  GroupBookingUpdateDto.JSON_PROPERTY_DESCRIPTION,
  GroupBookingUpdateDto.JSON_PROPERTY_LOCATION,
  GroupBookingUpdateDto.JSON_PROPERTY_WORK_HOURS,
  GroupBookingUpdateDto.JSON_PROPERTY_AVAILABILITY_INTERVALS,
  GroupBookingUpdateDto.JSON_PROPERTY_CONTEXT,
  GroupBookingUpdateDto.JSON_PROPERTY_START_CONFERENCE,
  GroupBookingUpdateDto.JSON_PROPERTY_OPEN_MEETING_URL,
  GroupBookingUpdateDto.JSON_PROPERTY_CLIENT_ORG_ID
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class GroupBookingUpdateDto {
  ...
  public GroupBookingUpdateDto() { 
  }

  public GroupBookingUpdateDto name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GroupBookingUpdateDto durationMinutes(@javax.annotation.Nullable Integer durationMinutes) {
  ...
  public GroupBookingUpdateDto bufferBetweenMinutes(@javax.annotation.Nullable Integer bufferBetweenMinutes) {
  ...
  public GroupBookingUpdateDto availabilityStep(@javax.annotation.Nullable Integer availabilityStep) {
  ...
  public GroupBookingUpdateDto startAfterMinutes(@javax.annotation.Nullable Integer startAfterMinutes) {
  ...
  public GroupBookingUpdateDto startTime(@javax.annotation.Nullable OffsetDateTime startTime) {
  ...
  public GroupBookingUpdateDto endTime(@javax.annotation.Nullable OffsetDateTime endTime) {
  ...
  public GroupBookingUpdateDto timeAvailableFor(@javax.annotation.Nullable String timeAvailableFor) {
  ...
  public GroupBookingUpdateDto subject(@javax.annotation.Nullable String subject) {
  ...
  public GroupBookingUpdateDto description(@javax.annotation.Nullable String description) {
  ...
  public GroupBookingUpdateDto location(@javax.annotation.Nullable String location) {
  ...
  public GroupBookingUpdateDto workHours(@javax.annotation.Nullable WeekWorkSchedule workHours) {
  ...
  public GroupBookingUpdateDto availabilityIntervals(@javax.annotation.Nullable AvailabilityIntervals availabilityIntervals) {
  ...
  public GroupBookingUpdateDto context(@javax.annotation.Nullable String context) {
  ...
  public GroupBookingUpdateDto startConference(@javax.annotation.Nullable Boolean startConference) {
  ...
  public GroupBookingUpdateDto openMeetingUrl(@javax.annotation.Nullable String openMeetingUrl) {
  ...
  public GroupBookingUpdateDto clientOrgId(@javax.annotation.Nullable String clientOrgId) {
  ...
  /**
   * Return true if this GroupBookingUpdateDto object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GroupBookingUpdateDto groupBookingUpdateDto = (GroupBookingUpdateDto) o;
    return Objects.equals(this.name, groupBookingUpdateDto.name) &&
        Objects.equals(this.durationMinutes, groupBookingUpdateDto.durationMinutes) &&
        Objects.equals(this.bufferBetweenMinutes, groupBookingUpdateDto.bufferBetweenMinutes) &&
        Objects.equals(this.availabilityStep, groupBookingUpdateDto.availabilityStep) &&
        Objects.equals(this.startAfterMinutes, groupBookingUpdateDto.startAfterMinutes) &&
        Objects.equals(this.startTime, groupBookingUpdateDto.startTime) &&
        Objects.equals(this.endTime, groupBookingUpdateDto.endTime) &&
        Objects.equals(this.timeAvailableFor, groupBookingUpdateDto.timeAvailableFor) &&
        Objects.equals(this.subject, groupBookingUpdateDto.subject) &&
        Objects.equals(this.description, groupBookingUpdateDto.description) &&
        Objects.equals(this.location, groupBookingUpdateDto.location) &&
        Objects.equals(this.workHours, groupBookingUpdateDto.workHours) &&
        Objects.equals(this.availabilityIntervals, groupBookingUpdateDto.availabilityIntervals) &&
        Objects.equals(this.context, groupBookingUpdateDto.context) &&
        Objects.equals(this.startConference, groupBookingUpdateDto.startConference) &&
        Objects.equals(this.openMeetingUrl, groupBookingUpdateDto.openMeetingUrl) &&
        Objects.equals(this.clientOrgId, groupBookingUpdateDto.clientOrgId);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupBookingUpdateDto {\n");
