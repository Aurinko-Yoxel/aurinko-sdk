 ...
 */
@JsonPropertyOrder({
  TaskCreate.JSON_PROPERTY_TITLE,
  TaskCreate.JSON_PROPERTY_PARENT_ID,
  TaskCreate.JSON_PROPERTY_PREVIOUS_ID,
  TaskCreate.JSON_PROPERTY_NOTES,
  TaskCreate.JSON_PROPERTY_STATUS,
  TaskCreate.JSON_PROPERTY_IMPORTANCE,
  TaskCreate.JSON_PROPERTY_DUE,
...
public class TaskCreate {
  ...
  public TaskCreate title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TaskCreate parentId(@javax.annotation.Nullable String parentId) {
  ...
  public TaskCreate previousId(@javax.annotation.Nullable String previousId) {
  ...
  public TaskCreate notes(@javax.annotation.Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public TaskCreate status(@javax.annotation.Nullable TaskStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TaskCreate importance(@javax.annotation.Nullable TaskImportance importance) {
  ...
  public TaskCreate due(@javax.annotation.Nullable OffsetDateTime due) {
    this.due = due;
    return this;
  }
  ...
  public TaskCreate startDateTime(@javax.annotation.Nullable OffsetDateTime startDateTime) {
  ...
  public TaskCreate categories(@javax.annotation.Nullable List<String> categories) {
    this.categories = categories;
    return this;
  }

  public TaskCreate addCategoriesItem(String categoriesItem) {
  ...
  /**
   * Return true if this TaskCreate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, taskCreate.title) &&
        Objects.equals(this.parentId, taskCreate.parentId) &&
        Objects.equals(this.previousId, taskCreate.previousId) &&
        Objects.equals(this.notes, taskCreate.notes) &&
        Objects.equals(this.status, taskCreate.status) &&
        Objects.equals(this.importance, taskCreate.importance) &&
        Objects.equals(this.due, taskCreate.due) &&
        Objects.equals(this.startDateTime, taskCreate.startDateTime) &&
        Objects.equals(this.categories, taskCreate.categories);
  }
