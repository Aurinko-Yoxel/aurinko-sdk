...
public class EmailDeletedPage {
  ...
  public EmailDeletedPage nextPageToken(String nextPageToken) {
  ...
  **/
  ...
  public EmailDeletedPage nextDeltaToken(String nextDeltaToken) {
  ...
  **/
  ...
  public EmailDeletedPage length(Integer length) {
    this.length = length;
    return this;
  }
  ...
  **/
  ...
  public EmailDeletedPage records(List<DeletedEmailMessage> records) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RECORDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecords(List<DeletedEmailMessage> records) {
    this.records = records;
  }
