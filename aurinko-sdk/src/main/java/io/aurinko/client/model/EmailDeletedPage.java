...
import io.aurinko.client.model.DeletedEmailMessage;
 ...
 */
@JsonPropertyOrder({
  EmailDeletedPage.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  EmailDeletedPage.JSON_PROPERTY_NEXT_DELTA_TOKEN,
...
public class EmailDeletedPage {
  ...
  @javax.annotation.Nullable
  private List<DeletedEmailMessage> records = new ArrayList<>();

  public EmailDeletedPage() { 
  }

  public EmailDeletedPage nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public EmailDeletedPage nextDeltaToken(@javax.annotation.Nullable String nextDeltaToken) {
  ...
  public EmailDeletedPage length(@javax.annotation.Nullable Integer length) {
    this.length = length;
    return this;
  }
  ...
  public EmailDeletedPage records(@javax.annotation.Nullable List<DeletedEmailMessage> records) {
    this.records = records;
    return this;
  }

  public EmailDeletedPage addRecordsItem(DeletedEmailMessage recordsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<DeletedEmailMessage> getRecords() {
    return records;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RECORDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecords(@javax.annotation.Nullable List<DeletedEmailMessage> records) {
    this.records = records;
  }


  /**
   * Return true if this EmailDeletedPage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EmailDeletedPage emailDeletedPage = (EmailDeletedPage) o;
    return Objects.equals(this.nextPageToken, emailDeletedPage.nextPageToken) &&
        Objects.equals(this.nextDeltaToken, emailDeletedPage.nextDeltaToken) &&
        Objects.equals(this.length, emailDeletedPage.length) &&
        Objects.equals(this.records, emailDeletedPage.records);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailDeletedPage {\n");
