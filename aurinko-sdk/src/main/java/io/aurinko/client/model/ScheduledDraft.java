 ...
 */
@JsonPropertyOrder({
  ScheduledDraft.JSON_PROPERTY_JOB_ID,
  ScheduledDraft.JSON_PROPERTY_SEND_TIME,
...
public class ScheduledDraft {
  ...
  @JsonCreator
  public ScheduledDraft(
    @JsonProperty(JSON_PROPERTY_JOB_ID) Long jobId, 
  ...
  /**
   * Return true if this ScheduledDraft object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ScheduledDraft scheduledDraft = (ScheduledDraft) o;
    return Objects.equals(this.jobId, scheduledDraft.jobId) &&
        Objects.equals(this.sendTime, scheduledDraft.sendTime) &&
        Objects.equals(this.status, scheduledDraft.status) &&
        Objects.equals(this.errorMessage, scheduledDraft.errorMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jobId, sendTime, status, errorMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScheduledDraft {\n");
