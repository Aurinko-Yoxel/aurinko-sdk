...
public class DayWorkSchedule {
  ...
  **/
  ...
  public DayWorkSchedule addWorkingIntervalsItem(WorkingInterval workingIntervalsItem) {
    if (this.workingIntervals == null) {
      this.workingIntervals = new ArrayList<>();
    }
    this.workingIntervals.add(workingIntervalsItem);
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this DayWorkSchedule object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DayWorkSchedule dayWorkSchedule = (DayWorkSchedule) o;
    return Objects.equals(this.dayOfWeek, dayWorkSchedule.dayOfWeek) &&
        Objects.equals(this.workingIntervals, dayWorkSchedule.workingIntervals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dayOfWeek, workingIntervals);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DayWorkSchedule {\n");
    sb.append("    dayOfWeek: ").append(toIndentedString(dayOfWeek)).append("\n");
    sb.append("    workingIntervals: ").append(toIndentedString(workingIntervals)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getWorkingIntervals() != null) {
      for (int i = 0; i < getWorkingIntervals().size(); i++) {
        if (getWorkingIntervals().get(i) != null) {
          joiner.add(getWorkingIntervals().get(i).toUrlQueryString(String.format("%sworkingIntervals%s%s", prefix, suffix,
