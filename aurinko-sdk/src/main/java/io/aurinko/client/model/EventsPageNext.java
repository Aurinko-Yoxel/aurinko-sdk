 ...
 */
@JsonPropertyOrder({
  EventsPageNext.JSON_PROPERTY_NEXT_PAGE_TOKEN,
...
public class EventsPageNext {
  ...
  public EventsPageNext() { 
  }

  public EventsPageNext nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public EventsPageNext length(@javax.annotation.Nullable Integer length) {
    this.length = length;
    return this;
  }
  ...
  public EventsPageNext records(@javax.annotation.Nullable List<Event> records) {
    this.records = records;
    return this;
  }

  public EventsPageNext addRecordsItem(Event recordsItem) {
  ...
  /**
   * Return true if this EventsPageNext object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EventsPageNext eventsPageNext = (EventsPageNext) o;
    return Objects.equals(this.nextPageToken, eventsPageNext.nextPageToken) &&
        Objects.equals(this.length, eventsPageNext.length) &&
        Objects.equals(this.records, eventsPageNext.records);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsPageNext {\n");
