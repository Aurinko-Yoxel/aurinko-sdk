 ...
 */
@JsonPropertyOrder({
  FreeBusyItem.JSON_PROPERTY_START,
...
public class FreeBusyItem {
  ...
  **/
  ...
  /**
   * Return true if this FreeBusyItem object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FreeBusyItem freeBusyItem = (FreeBusyItem) o;
    return Objects.equals(this.start, freeBusyItem.start) &&
        Objects.equals(this.end, freeBusyItem.end) &&
        Objects.equals(this.status, freeBusyItem.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(start, end, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FreeBusyItem {\n");
