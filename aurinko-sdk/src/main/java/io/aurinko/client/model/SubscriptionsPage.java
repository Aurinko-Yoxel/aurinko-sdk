 ...
 */
@JsonPropertyOrder({
  SubscriptionsPage.JSON_PROPERTY_OFFSET,
  SubscriptionsPage.JSON_PROPERTY_TOTAL_SIZE,
  SubscriptionsPage.JSON_PROPERTY_DONE,
  SubscriptionsPage.JSON_PROPERTY_RECORDS
})
...
public class SubscriptionsPage {
  ...
  @javax.annotation.Nullable
  private List<SubscriptionResponse> records = new ArrayList<>();

  public SubscriptionsPage() { 
  }

  public SubscriptionsPage offset(@javax.annotation.Nullable Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public SubscriptionsPage totalSize(@javax.annotation.Nullable Long totalSize) {
  ...
  public SubscriptionsPage done(@javax.annotation.Nullable Boolean done) {
    this.done = done;
    return this;
  }
  ...
  public SubscriptionsPage records(@javax.annotation.Nullable List<SubscriptionResponse> records) {
    this.records = records;
    return this;
  }

  public SubscriptionsPage addRecordsItem(SubscriptionResponse recordsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<SubscriptionResponse> getRecords() {
    return records;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RECORDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRecords(@javax.annotation.Nullable List<SubscriptionResponse> records) {
    this.records = records;
  }


  /**
   * Return true if this SubscriptionsPage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.offset, subscriptionsPage.offset) &&
        Objects.equals(this.totalSize, subscriptionsPage.totalSize) &&
        Objects.equals(this.done, subscriptionsPage.done) &&
        Objects.equals(this.records, subscriptionsPage.records);
  }
