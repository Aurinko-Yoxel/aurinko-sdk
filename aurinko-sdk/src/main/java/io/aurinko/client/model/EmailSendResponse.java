...
@JsonPropertyOrder({
  ...
  EmailSendResponse.JSON_PROPERTY_SUBMITTED_MESSAGE_ID,
...
public class EmailSendResponse {
  ...
  public static final String JSON_PROPERTY_SUBMITTED_MESSAGE_ID = "submittedMessageId";
  @javax.annotation.Nullable
  ...
  public EmailSendResponse submittedMessageId(@javax.annotation.Nullable String submittedMessageId) {
    this.submittedMessageId = submittedMessageId;
    return this;
  }

  /**
   * Message-Id header generated by Aurinko when SMTP sending. Note that some SMTP servers will override it.
   * @return submittedMessageId
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUBMITTED_MESSAGE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_SUBMITTED_MESSAGE_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubmittedMessageId(@javax.annotation.Nullable String submittedMessageId) {
    this.submittedMessageId = submittedMessageId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, emailSendResponse.status) &&
        ...
        Objects.equals(this.submittedMessageId, emailSendResponse.submittedMessageId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, id, submittedMessageId, threadId, trackingId, processingStatus, processingError);
  }
  ...
  public String toString() {
    ...
    sb.append("    submittedMessageId: ").append(toIndentedString(submittedMessageId)).append("\n");
