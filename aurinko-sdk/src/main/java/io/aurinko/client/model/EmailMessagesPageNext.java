...
public class EmailMessagesPageNext {
  ...
  public EmailMessagesPageNext nextPageToken(String nextPageToken) {
  ...
  **/
  ...
  public EmailMessagesPageNext length(Integer length) {
    this.length = length;
    return this;
  }
  ...
  **/
  ...
  public EmailMessagesPageNext records(List<EmailMessage> records) {
