 ...
 */
@JsonPropertyOrder({
  EmailMessagesPageNext.JSON_PROPERTY_NEXT_PAGE_TOKEN,
  EmailMessagesPageNext.JSON_PROPERTY_LENGTH,
  EmailMessagesPageNext.JSON_PROPERTY_RECORDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.10.0")
public class EmailMessagesPageNext {
  ...
  public EmailMessagesPageNext() { 
  }

  public EmailMessagesPageNext nextPageToken(@javax.annotation.Nullable String nextPageToken) {
  ...
  public EmailMessagesPageNext length(@javax.annotation.Nullable Integer length) {
    this.length = length;
    return this;
  }
  ...
  public EmailMessagesPageNext records(@javax.annotation.Nullable List<EmailMessage> records) {
    this.records = records;
    return this;
  }

  public EmailMessagesPageNext addRecordsItem(EmailMessage recordsItem) {
  ...
  /**
   * Return true if this EmailMessagesPageNext object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EmailMessagesPageNext emailMessagesPageNext = (EmailMessagesPageNext) o;
    return Objects.equals(this.nextPageToken, emailMessagesPageNext.nextPageToken) &&
        Objects.equals(this.length, emailMessagesPageNext.length) &&
        Objects.equals(this.records, emailMessagesPageNext.records);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailMessagesPageNext {\n");
